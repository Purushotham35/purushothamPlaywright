...
test("verify add job title", async ({ page, browserName }) => {
  switch (browserName) {
    case "chromium":
      ...
      await page
        .locator(
          "(//li[contains(@class,'oxd-topbar-body-nav-tab --parent')]/following-sibling::li)[1]"
        )
        .click();
      ...
      await page
        ...
        .fill("qa enginner 9" + r);
      await page
        .locator("textarea[placeholder='Type description here']")
        .fill("automation");
      await page
        .locator("textarea[placeholder='Add note']")
        .fill("add some note here");
      await page.locator("button[type='submit']").click();
    ...
    case "firefox":
      ...
      await page
        .locator("(//span[@class='oxd-topbar-body-nav-tab-item'])[2]")
        .click();
      ...
      await expect(
        page.locator(
          'xpath=(//h6[contains(@class,"oxd-text oxd-text--h6")])[2]'
        )
      ).toHaveText("Add Pay Grade");
    ...
    case "webkit":
      ...
      await page
        .locator("(//a[@class='oxd-topbar-body-nav-tab-link'])[3]")
        .click();
      ...
      await page.locator("//button[@type='submit']").click();
      await expect(page).toHaveURL(
        "https://opensource-demo.orangehrmlive.com/web/index.php/admin/saveEmploymentStatus"
      );
