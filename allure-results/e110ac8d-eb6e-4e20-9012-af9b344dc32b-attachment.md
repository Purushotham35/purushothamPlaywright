...
- Location: C:\Playwright Automation\tests\apiTest\getRequest.spec.js:22:5

# Error details

```
Error: apiRequestContext.get: getaddrinfo ENOTFOUND opensource-demo.orangehrmlive.com
Call log:
  - → GET https://opensource-demo.orangehrmlive.com/web/index.php/api/v2/admin/subunits
    ...
    at C:\Playwright Automation\tests\apiTest\getRequest.spec.js:28:33
```
